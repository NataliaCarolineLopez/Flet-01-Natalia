...
def main(page: ft.Page):
    ...
    linha_botoes = ft.Row(
        controls=[
            ft.ElevatedButton("Botão 1", bgcolor=ft.Colors.PINK, color=ft.Colors.WHITE),
            ft.ElevatedButton("Botão 2", bgcolor=ft.Colors.PURPLE, color=ft.Colors.WHITE),
    ...
    layout_principal = ft.Column(
        controls=[
            ...
            coluna_caixas,
            ft.Text("Layout organizado! 🎉", size=14, color=ft.Colors.WHITE)
        ],

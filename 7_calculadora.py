...
def main(page: ft.Page):
    ...
    def calcular(e):
        try:
            ...
            if not op:
                ...
                resultado.color = ft.Colors.PURPLE_700
        except ValueError:
    ...
    def limpar(e):
        ...
        resultado.value, resultado.color = "Campos limpos! ✨", ft.Colors.WHITE
        page.update()
    ...
    page.add(
        ft.Column([
            ...
            ft.Row([
                ft.ElevatedButton(" Calcular", on_click=calcular, width=150, bgcolor=ft.Colors.PURPLE_300, color=ft.Colors.WHITE),
                ft.ElevatedButton(" Limpar", on_click=limpar, width=150, bgcolor=ft.Colors.PURPLE_200, color=ft.Colors.WHITE),
